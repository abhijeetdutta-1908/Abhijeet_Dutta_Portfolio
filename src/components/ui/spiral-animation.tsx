...
class AnimationController {
	...
	public render() {
		...
		for (const star of this.stars) {
			star.render(t1, this, this.cameraZ, this.viewZoom);
		}
...
class Star {
	...
	render(p: number, controller: AnimationController, cameraZ: number, viewZoom: number) {
...
export function SpiralAnimation() {
	...
	return (
		<div className='spiral-animation'>
			<canvas ref={canvasRef} className='spiral-animation__canvas' />
		</div>
	);
}
